#ifndef _MODBUS_RTU_SERVER_CLASS_SRC_MODBUS_SERVER_CLASS_HPP
#define _MODBUS_RTU_SERVER_CLASS_SRC_MODBUS_SERVER_CLASS_HPP
...
#endif // _MODBUS_RTU_SERVER_CLASS_SRC_MODBUS_SERVER_CLASS_HPP //
